...
| **`@nexus/cloud`** | Backend API | Express routes, Auth, Team/Project services, **Prisma schema + repositories (PostgreSQL)**, **rate limiting** |
...
- [x] **1287 tests passing across all packages**
...
**Testing:** Jest · ts-jest · 1287 tests
